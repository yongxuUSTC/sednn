...
class CNN(nn.Module):
    def __init__(self, filter_len):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=n_hid, kernel_size=filter1_len, stride=1, padding=0, dilation=1, groups=1, bias=True)
        self.conv2 = nn.Conv1d(in_channels=n_hid, out_channels=1, kernel_size=filter2_len, stride=1, padding=0, dilation=1, groups=1, bias=True)
